...
if __name__ == "__main__":
    # Seed the in-memory database for development and E2E testing
    crud.reset_recipes_db()
    crud.create_recipe(
        name="Spaghetti Bolognese",
        description="A classic Italian meat-based sauce served with spaghetti.",
        instructions="1. Cook spaghetti. 2. Make sauce. 3. Combine and serve.",
    ...
    crud.create_recipe(
        ...
        instructions="1. Dice cooked chicken. 2. Mix with mayonnaise.",
        ingredients_data=[
