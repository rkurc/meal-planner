...
mealplan_recipes = db.Table(
    "mealplan_recipes",
    db.Column(
        "meal_plan_id", db.String(36), db.ForeignKey("meal_plans.id"), primary_key=True
    ),
    db.Column(
        "recipe_id", db.String(36), db.ForeignKey("recipes.id"), primary_key=True
    ),
)
